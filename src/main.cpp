...
#if defined(NDEBUG)
# error "Vaultcoin cannot be compiled without assertions."
#endif
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Vaultcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Vaultcoin: 3.5 days
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Vaultcoin: increase each by adding 2 to bitcoin's value.
